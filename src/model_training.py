...
class ModelTraining:
    def __init__(self,data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key="kDpsZaZOisidyoapznJxeh2PP",
            project_name="mlops-project1",
            workspace="noamessi07"
        )
    ...
    def train_model(self):
        try:
            ...
            try:
                ...
                for epoch in range(len(history.history['loss'])):   ## log metrics to COMET ML
    ...
    def save_model_weights(self,model):
        try:
            ...
            self.experiment.log_asset(MODEL_PATH)  ## log model and weights to COMET ML
